...
void loop() {
    ...
    switch (robotState) {
        ...
        case BACKWARD_CURVE: {
	    	...
	    	int pwmOuter = map(10, 0, -100, -outerMinimum, -255);
    		int pwmInner = map(-100, 0, -100, -innerMinimum, -255);
	    	...
	    	pwmOuter = map(70, 0, -100, -outerMinimum, -255);
    		pwmInner = map(-100, 0, -100, -innerMinimum, -255);
    		driveMotor(outerMotor, pwmOuter);
    		driveMotor(innerMotor, pwmInner);

    		delay(400);

	    	pwmOuter = map(10, 0, -100, -outerMinimum, -255);
    		pwmInner = map(-100, 0, -100, -innerMinimum, -255);
    		driveMotor(outerMotor, pwmOuter);
    		driveMotor(innerMotor, pwmInner);
