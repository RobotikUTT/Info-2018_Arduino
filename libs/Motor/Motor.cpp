...
Motor::Motor(uint8_t enable_pin, uint8_t dir_pin, uint8_t brake_pin, uint8_t foreward_sense)
{
...
Motor::Motor(uint8_t enable_pin, uint8_t dir_pin, uint8_t foreward_sense)
{
	Motor(enable_pin,dir_pin,0,foreward_sense);
}
